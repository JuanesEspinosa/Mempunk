...
1. Le o `CLAUDE.md` do vault
2. Ve o indice de projetos com links diretos
3. Pergunta em qual projeto voce quer trabalhar
4. Le o overview e as convencoes do projeto
5. Le os ultimos 3 session logs e o backlog
